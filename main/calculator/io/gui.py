...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ""
        Entry(width=17, bg="#cdf", font=("Arial Bold", 28),textvariable=self.equation).place(x=0, y=0)
        ...
        Button(width=11, height=4, text="=", relief="flat", bg="lightblue", command=self.evaluate).place(x=270, y=350)
    ...
    def evaluate(self):
        result = calculate(self.entry_value)
